...
export function MovementForm({
  ...
  const [expenseItems, setExpenseItems] = useState<CreateExpenseItemData[]>([])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: CreateMovementData | UpdateMovementData = {
        ...
        expense_items: !isIncome && expenseItems.length > 0 
          ? expenseItems.map(item => ({
              ...item,
              id: item.id || undefined, // Incluir ID si existe (para updates)
            }))
          : undefined,
      }
  ...
  return (
    <div className="bg-background w-full max-w-5xl mx-auto rounded-lg shadow-sm">
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <Label htmlFor="movement_type_id" className="text-sm font-medium">
                    Tipo de Movimiento
                  </Label>
              ...
              <div className="space-y-2 relative">
                <div className="flex items-center">
                  <Label htmlFor="booking_id" className="text-sm font-medium">
                    Reserva
                  </Label>
                  {isIncome && <span className="text-destructive ml-1">*</span>}
                  {!isIncome && (
                ...
                {errors.booking_id && (
                  <p className="text-sm text-red-500 mt-1">{errors.booking_id}</p>
                )}
                {!isIncome && (
              ...
              {!isIncome && (
                <div className="space-y-2">
                  <div className="flex items-center">
                    <Label htmlFor="service_provider_id" className="text-sm font-medium">
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <Label htmlFor="treasury_account_id" className="text-sm font-medium">
                    Cuenta de Tesorería
                  </Label>
                  <span className="text-destructive ml-1">*</span>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <Label htmlFor="movement_status_id" className="text-sm font-medium">
                    Estado
                  </Label>
                  <span className="text-destructive ml-1">*</span>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <Label htmlFor="movement_date" className="text-sm font-medium">
